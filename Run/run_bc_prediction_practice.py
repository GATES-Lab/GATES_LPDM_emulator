...
from new_graphnet.graphnet_LPDM_emulator.full_bc_prediction_practice import train_bc_prediction_pipeline_practice, train_bc_prediction_pipeline_data_saving
