#!/bin/bash
#SBATCH --job-name=is_CHINA_match_oracle_round_time
...
#SBATCH --gres=gpu:1
#SBATCH --time=6:00:00
#SBATCH --output=output_logs/%j_is_CHINA_match_oracle_round_time.out
...
PARAM_FILE="${PARAM_FILE:-NEW_parameter_CHINA.json}"
