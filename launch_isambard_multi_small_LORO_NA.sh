#!/bin/bash
#SBATCH --job-name=is_MRM_small_LORO_NA
...
#SBATCH --gres=gpu:1
#SBATCH --time=5:00:00
#SBATCH --output=output_logs/%j_is_MRM_small_LORO_NA.out
...
PARAM_FILE="${PARAM_FILE:-NEW_parameter_multiregion_small_LORO_NA.json}"
