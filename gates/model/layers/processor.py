...
class SatelliteProcessor(torch.nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            residuals (bool, optional): Whether to have the mesh update with residuals (change from the previous state) or not (replace the previous state). Defaults to False.
        """
        super().__init__()
