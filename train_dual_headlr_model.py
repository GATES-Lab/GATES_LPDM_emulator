...
def train_and_save_model(parameters, model_save_dir, wandb_name=None, data_bundle=None):
    ...
    # Swap the single-LR optimizer from setup_dual_model for the per-head one. Done before any
    # training step, so no optimizer state is lost; model_ctx.lr stays the top-level default.
