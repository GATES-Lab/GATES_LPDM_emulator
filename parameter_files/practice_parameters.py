...
#sim_hparams['train_load_data']['year'] = "201[3-5]" # Added this for second set of simulations
#sim_hparams['test_load_data']['year'] = "2016"
...
practice_hparams_list = [sim_hparams]
