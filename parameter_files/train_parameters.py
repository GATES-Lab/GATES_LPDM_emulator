...
sim_hparams_2["use_baselines"] = False
sim_hparams_2["train_load_data"]["domain_to_cut"]= {"lat":[-35.5,-0.5], "lon":[-77.5,7.5]} # Size 150 by 150
...
sim_hparams_3["train_load_data"]["domain_to_cut"]= {"lat":[-39.7,4.7]}# Size 190 by 190
...
sim_hparams_4["train_load_data"]["freq"] = 2
...
sim_hparams_5["use_baselines"] = False
sim_hparams_5["train_load_data"]["domain_to_cut"]= {"lat":[-35.5,-0.5], "lon":[-77.5,7.5]} # Size 150 by 150
sim_hparams_5['learning_rate'] = 5e-5
sim_hparams_5["train_load_data"]["coarsening_factor"] = 1
sim_hparams_5["train_load_data"]["freq"] = 2

# Experiment 3, full domain but high learning rate
sim_hparams_6 = copy.deepcopy(hparams)
sim_hparams_6['normalization'] = 'all'
sim_hparams_6["use_baselines"] = False
sim_hparams_6["train_load_data"]["domain_to_cut"]= {"lat":[-39.7,4.7]}# # Size 150 by 150
sim_hparams_6['learning_rate'] = 5e-5
sim_hparams_6["train_load_data"]["coarsening_factor"] = 1
sim_hparams_6["train_load_data"]["freq"] = 2
