...
from model.layers.decoder import SatelliteDecoder, SatelliteDecoderClassifier, SatelliteDecoderConvClassifier
...
class GraphSatelliteForecasterConvClassifier(torch.nn.Module): #, PyTorchModelHubMixin
    """Main weather prediction model from the paper"""
    def __init__(
        self,
        lat_lons: list,
        ...
        higher_mesh_res=0,
        idx_latlon=None,
        concat_decoder_neighbours=False, concat_decoder_neighbours_2=False, better_meshnodes=False, scatter="mean",disaggregated=False, batchsize=5, attention=False, release_coords="default", release_edges=False, decoder_append_latlon=False, concat_enc_neighbours=False,initial_enc=False, num_classes=4,input_height = 100, input_width = 100
    ):
        """
        Graph Weather Model based off https://arxiv.org/pdf/2202.07575.pdf
        ...
        self.decoder = SatelliteDecoderConvClassifier(
            lat_lons=lat_lons,
            h_grid=self.encoder.h3_grid,
            whole_world=whole_world,
            resolution=resolution,
        ...
        self.decoder = SatelliteDecoderConvClassifier(
            ...
            mlp_norm_type=norm_type,
            hidden_dim_decoder=hidden_dim_decoder,
            use_checkpointing=use_checkpointing , dropout=dropout, final_activation=decoder_final_layer, n_neighbouresiduals=residuals,
            hidden_layers_decoder=hidden_layers_decoder,
            use_checkpoirs=n_decoder_neighbours, concat_neighbours=concat_decoder_neighbours, concat_neighbours_2=concat_decoder_neighbours_2,idx_latlon=idx_latlon, append_latlon=decoder_append_latlon,input_height=input_height, input_width=input_width
        )
        '''
