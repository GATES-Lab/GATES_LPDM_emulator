...
data = LoadSatelliteData("201[4-5]", region="BRAZIL", freq=3, metsize=50, size = 50, verbose=True, topog="default", met_datadir="/group/chemistry/acrg/met_archive/UM/cut_SOUTHAMERICA_big/Met_cut_v2_50_")
test_data = LoadSatelliteData(2016, region="BRAZIL", freq=10, metsize=50, size =50, topog="default", verbose=True,  met_datadir="/group/chemistry/acrg/met_archive/UM/cut_SOUTHAMERICA_big/Met_cut_v2_50_")
